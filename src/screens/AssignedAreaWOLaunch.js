...
class AssignedAreaWOLaunch extends Component {
            ...
            return (
                <View key={i}>
                    ...
                    {data.villages.map((mdata, i) => {
                        ...
                        return (
                            <TouchableHighlight underlayColor='#fff' key={i} style={{}}  onPress={() => this.props.navigation.navigate('HazardList', {
...
export default AssignedAreaWOLaunch;