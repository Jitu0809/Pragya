...
class CommonForm3 extends Component {
   ...
   // console.log("QuestionDisplaced",this.state.questions);
    ...
    requestToSubmit = async () => {
       ...
       // console.log("INPUT QUESTIONS",inputQuestions);
        ...
        data = { ...data, questions ,SubcategoryId, document, name_disease, no_disease,Situation_value}
        console.log(data)
                                            ...
                                            { mdata.id === "1033"  && this.state.showInputField  &&  
                                                <View>
                                                   <TextInput
                                                     ...
                                                     onChangeText={(text) => this.setState({name_disease:text})}
                                                   ...
                                                   />
                                                    <TextInput
                                                     ...
                                                     style={styles.textInput}
                                                     onChangeText={(text) => this.setState({no_disease:text})}
                                                   />
                                              </View>
                                            }
...
export default withNavigation(CommonForm3)