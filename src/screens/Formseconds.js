...
class Formseconds extends Component {
  ...
  onSubmitHandler = () => {
    ...
    if (this.state.required=="") {
      const validate =  Alert.alert(
        ...
        [
          ...
          {
            text: "Cancel",
            onPress: () => this.props.navigation.navigate('Formseconds'),
            style: "cancel"
          },
          { text: "OK", onPress: () => this.props.navigation.navigate('Formseconds'),}
        ]
      );
    ...
    this.props.navigation.navigate('Formseconds2', { data, nextFormType })
