...
class Formsecond extends Component {
  ...
  onSubmitHandler = () => {
    ...
    if (this.state.required=="") {
      const validate =  Alert.alert(
        ...
        [
          ...
          {
            text: "Cancel",
            onPress: () => this.props.navigation.navigate('Formsecond'),
            style: "cancel"
          },
          { text: "OK", onPress: () => this.props.navigation.navigate('Formsecond'),}
        ]
      );
    ...
    this.props.navigation.navigate('Formsecond2', { data, nextFormType })
